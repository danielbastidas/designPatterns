...
class QuadraticEquationSolver
{
    ...
    public Pair<Complex, Complex> solve(double a, double b, double c)
    {
        ...
        Complex bComplex = new Complex(-1*b,0);
        Complex dividend = new Complex(2*a,0);

        Complex positivePart = bComplex.plus(root).divides(dividend);
        Complex negativePart = bComplex.minus(root).divides(dividend);

        Pair<Complex, Complex> result = new Pair(positivePart, negativePart);
        return result;
